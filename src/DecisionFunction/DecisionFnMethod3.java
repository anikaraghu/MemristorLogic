 ...
 */
public class DecisionFnMethod3 extends DecisionFunctionMethod{
    ...
    public ArrayList<ArrayList<Integer>> evaluate(ArrayList<ArrayList<Integer>> terms) {
        ...
        maxLiteralCount = uniqueLiterals(terms).size() + 1;
    ...
    //finds the most heavily weighted term
    private ArrayList<Integer> findBestLiterals (ArrayList<ArrayList<Integer>> terms) {
        ...
        int[] literalOccurences = new int[maxLiteralCount];
        ...
        ArrayList<Integer> tempBestTerm = new ArrayList<>();
        int termScore = 0;
        int termScoreTemp = 0;
        ...
        for(ArrayList<Integer> term: terms) {
            ...
            for(int i: allLiterals) {
                if (term.contains(i)) {
                    termScoreTemp += literalOccurences[i];
                }
            }
